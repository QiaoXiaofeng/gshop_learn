<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="shops.length">
      <li class="shop_li border-1px" v-for="(shop,idx) in shops" :key="idx">
        <a>
          <div class="shop_left">
            <img class="shop_img" :src="IMAGE_BASE_URL+shop.image_path">
          </div>
...
export default {
  data() {
    return {
      IMAGE_BASE_URL: "http://elm.cangdu.org/img/"
    };
  },
  computed: {
    ...mapState(["shops"])
